...
%name pInclude Include
%name pDef Def
%name pListDef ListDef
%name pListInclude ListInclude
%name pArg Arg
...
%token
  ...
  L_integ       { PT _ (TI $$)            }
  L_quoted      { PT _ (TL $$)            }
  L_IncludePath { PT _ (T_IncludePath $$) }
  L_Id          { PT _ (T_Id $$)          }
...
IncludePath :: { AbsCPP.IncludePath }
IncludePath  : L_IncludePath { AbsCPP.IncludePath $1 }

Id :: { AbsCPP.Id }
Id  : L_Id { AbsCPP.Id $1 }

Program :: { AbsCPP.Program }
Program : ListInclude ListDef { AbsCPP.PDefs $1 $2 }

Include :: { AbsCPP.Include }
Include : '#include' '<' IncludePath '>' { AbsCPP.Include $3 }
...
ListInclude :: { [AbsCPP.Include] }
ListInclude
  : {- empty -} { [] } | Include ListInclude { (:) $1 $2 }
