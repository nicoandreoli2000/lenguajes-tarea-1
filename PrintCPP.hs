...
instance Print AbsCPP.IncludePath where
  prt _ (AbsCPP.IncludePath i) = doc $ showString i
instance Print AbsCPP.Id where
  prt _ (AbsCPP.Id i) = doc $ showString i
instance Print AbsCPP.Program where
  prt i = \case
    AbsCPP.PDefs includes defs -> prPrec i 0 (concatD [prt 0 includes, prt 0 defs])

instance Print AbsCPP.Include where
  prt i = \case
    AbsCPP.Include includepath -> prPrec i 0 (concatD [doc (showString "#include"), doc (showString "<"), prt 0 includepath, doc (showString ">")])
